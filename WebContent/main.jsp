...
<!--主页！当前登录用户：${currentUser.username}&nbsp;<a href="logout">注销</a>  -->
     <div region="north" style="height: 80px;background-color: #E0EDEF">
     	...
     	<div style="padding-top: 50px;padding-right: 20px;">
     		<font color="black" size="4">当前用户：${currentUser.username}&nbsp;<a href="logout">注销</a></font>
     ...
     <div region="south" style="height: 25px;" align="center">版权所有<a href="www.java1234.com">www.java1234.com</a></div>
</body>
</html>